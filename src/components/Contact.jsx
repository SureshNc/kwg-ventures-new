        ...
        <div className="container">
          <div className="section-head">
            <div>
              ...
              <h2 className="h2-xl" style={{ color: '#fff' }}>Let's discuss your next market.</h2>
            </div>
            <div>
              <p className="lede">Tell us where you're going, what you're trying to achieve and where you need support. A senior member of KWG will respond within two business days.</p>
            </div>
          </div>
          ...
          <div className="contact-grid">
            <Reveal className="contact-info">
              ...
              <div className="item">
                ...
                <div><div className="lbl">Headquarters</div><div className="val">Headquarters: Toronto, Canada</div></div>
              </div>
              <div className="item">
                <div className="ico">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.362 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.338 1.85.573 2.81.7A2 2 0 0122 16.92z" /></svg>
            ...
            <Reveal as="form" className="form-card" id="contactForm" noValidate ref={formRef} onSubmit={handleSubmit}>
              ...
              <div className="form-row">
                ...
                <div className="field">
                  <label htmlFor="geography">Geography / Corridor</label>
              ...
              <div className="form-row">
                <div className="field full">
                  <label htmlFor="message">What are you looking to accomplish?</label>
                  <textarea id="message" name="message" required placeholder="Tell us the market, objective and current challenge..."></textarea>
                </div>
              </div>
