...
const PILLARS = [
  {
    ...
    desc: 'Direct access to ministries and regulators across six corridors.',
  ...
  },
  {
    ...
    desc: 'Legal, immigration, licensing and tax — through trusted local partners.',
      ...
      <div className="container">
        <div className="section-head">
          <div>
            ...
            <h2 className="h2-xl">Four pillars. One mandate.</h2>
          </div>
          <p className="lede">Capital, corridors, industrial execution — one point of accountability.</p>
        </div>
